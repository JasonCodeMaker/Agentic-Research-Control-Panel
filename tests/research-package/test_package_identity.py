...
def _active_package() -> dict:
    return {
        ...
        "blocker": None,
        "problem": "The released method lacks an auditable reproduction in this codebase.",
        "motivation": "A faithful reproduction establishes evidence before transfer work begins.",
        "objective": "Reproduce the method and record enough evidence to judge implementation fidelity.",
        "hypothesis": "The released method can be reproduced under its declared protocol.",
